...
export const tool: Tool = {
  name: 'retrieve_purchase_categories',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nRécupère les détails d'une catégorie d'achat spécifique.\n\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/purchase_category_retrieve_response',\n  $defs: {\n    purchase_category_retrieve_response: {\n      type: 'object',\n      properties: {\n        _id: {\n          type: 'string'\n        },\n        company: {\n          type: 'string'\n        },\n        createdAt: {\n          type: 'string',\n          format: 'date-time'\n        },\n        name: {\n          type: 'string'\n        },\n        state: {\n          type: 'string',\n          enum: [            'active',\n            'inactive'\n          ]\n        },\n        updatedAt: {\n          type: 'string',\n          format: 'date-time'\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      uid: {
...
export const handler = async (client: Wuro, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.purchaseCategories.retrieve(uid)));
  } catch (error) {
