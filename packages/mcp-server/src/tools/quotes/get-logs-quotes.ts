...
export const metadata: Metadata = {
  ...
  operationId: 'getAllQuoteLogs',
};

export const tool: Tool = {
  name: 'get_logs_quotes',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nRécupère les logs d'actions effectuées sur tous les devis.\n\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/quote_get_logs_response',\n  $defs: {\n    quote_get_logs_response: {\n      type: 'object',\n      properties: {\n        logs: {\n          type: 'array',\n          items: {\n            type: 'object',\n            additionalProperties: true\n          }\n        },\n        total: {\n          type: 'integer'\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      limit: {
...
export const handler = async (client: Wuro, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.quotes.getLogs(body)));
  } catch (error) {
