...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      number: {
        type: 'string',
        description: 'Numéro de facture (recherche exacte)',
      },
      search: {
        type: 'string',
        description: 'Recherche textuelle dans les factures',
      },
      skip: {
        type: 'integer',
        description: 'Nombre de factures à ignorer (pagination)',
      },
      sort: {
        type: 'string',
        description: 'Champ de tri et direction (ex. "date:-1" pour tri décroissant par date)',
      },
      state: {
        type: 'string',
        description: 'Filtre par état de la facture',
        enum: ['draft', 'waiting', 'paid', 'notpaid', 'late', 'inactive'],
      },
      type: {
        type: 'string',
        description: 'Filtre par type de facture',
