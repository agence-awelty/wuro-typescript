...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      url: {
        type: 'string',
        description: "URL unique pour l'entreprise (obligatoire)",
      },
      addresses: {
        type: 'array',
        items: {
      ...
      company_type: {
        type: 'string',
        description: "ID du type d'entreprise (SARL, SAS, etc.)",
      },
      email: {
        type: 'string',
      ...
      nic: {
        type: 'string',
        description: 'Code NIC',
      },
      num_rcs: {
        type: 'string',
        description: "Numéro d'inscription au RCS",
      },
      num_trade_directory: {
        type: 'string',
        description: 'Numéro au répertoire des métiers',
      },
      share_capital: {
        type: 'number',
