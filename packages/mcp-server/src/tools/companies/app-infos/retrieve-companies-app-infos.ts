...
export const metadata: Metadata = {
  ...
  operationId: 'getCurrentCompanyAppInfos',
};

export const tool: Tool = {
  name: 'retrieve_companies_app_infos',
  description:
...
export const handler = async (client: Wuro, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.companies.appInfos.retrieve()));
  } catch (error) {
