...
describe('resource users', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.users.create({ email: 'dev@stainless.com', password: 'password' });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.users.list(
        { company: 'company', limit: 0, search: 'search', skip: 0 },
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.users.delete({ email: 'dev@stainless.com' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.users.delete({ email: 'dev@stainless.com' });
  });
